...
For exercise 3, your Github ID should be included in an email to bioinformatics resource centre by the deadline listed below.

The directory of R code and image for xercise 2, question 7 should be made available to me by deadline below.
...
* Question 3 - Read in the absolute expression table, add 1 to every value in table and make a boxplot of log2 expression values for all samples.
...
* Question 5 - Using the absolute expression table, identify the genes whose expression is in the top 40%. Filter the results from the differential expression table to these results and plot the log2 basemean on X and log2FoldChange on Y. Highlight genes who have padj < 0.05
...
* Question 5 - Make a violin plot of the log10 of findPeaks.Score for each chromosome as shown below using ggplot graphics.
